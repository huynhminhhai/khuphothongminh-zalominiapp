...
const InforResidentCraftList: React.FC = () => {
    ...
    return (
        <Box>
            <Box mt={4} pt={4} pb={2} px={4} flex alignItems="center" justifyContent="space-between" className="gap-3">
                <h3 className="text-[16px] font-semibold whitespace-nowrap">Thành viên tạm trú</h3>
