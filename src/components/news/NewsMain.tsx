            ...
            >
                ...
                <Box px={4}>
                    <div className="flex-1 flex flex-col justify-center mt-3 border-b-[1px] pb-4">
                        <h3 className="text-[17px] leading-[22px] font-semibold line-clamp-2 mb-1">{data.tieuDe || data.moTa}</h3>
                        <div className="line-clamp-3 text-[15px] leading-[20px] font-medium text-gray-color mb-2">{data.moTa}</div>
                        <div className="text-end text-[14px] leading-[1] text-gray-color font-medium">{formatDate(data.ngayXuatBan)}</div>
                    </div>
                </Box>
            </div>
        </Box>
