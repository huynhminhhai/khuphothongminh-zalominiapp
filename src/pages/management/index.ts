 ...
 * SURVEY 
 **/ 
export { default as SurveyManagementPage } from "./management-surey/survey-management";
...
export { default as ResidentProfileAddPage } from "./management-resident/resident-profile-create";
